...
const MedecinProfilePage = () => {
  ...
  // Utilisez user.id au lieu de searchParams ou inverse ?
...
const MedecinProfilePage = () => {
  ...
  // CORRECTION : On récupère l'ID du patient depuis l'URL, pas l'ID du médecin connecté
  const idPatient = searchParams.get("id");
  ...
  const chargerInfos = async () => {
    ...
    try {
      ...
      // Charger l'aide-soignant si assigné
      if (patientData.fk_aide_soignant) {
